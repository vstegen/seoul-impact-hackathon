            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Welcome to NestledHope <br />
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  At NestledHope, we empower runaway youths through
                  comprehensive support, including shelter, meals, counseling,
                  education, and community resources. Our empathetic approach
                  respects each individual's unique journey. Join us in breaking
                  the cycle of homelessness and creating a supportive community.
                  Connect with us to learn more or get involved in making a
                  positive impact.
                </p>
          ...
          <div className="mt-16 flex justify-center">
            <p className="relative rounded-full px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/10 hover:ring-gray-900/20">
              <span className="hidden md:inline">
                Donate to Support Runaway Youths
              </span>
